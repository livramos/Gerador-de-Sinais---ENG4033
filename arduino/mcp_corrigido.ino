...
void atualizaDAC()
{
    ...
    // calcula o tempo entre um ponto e outro usando a frequencia
    unsigned long tempoEntrePontos = 1000000.0 / (op.freq * op.sinal.qtdPontos);

    // protecao para nao tentar mandar rapido demais para o MCP4725
    if (tempoEntrePontos < 100)
    {
        tempoEntrePontos = 100;
    }
